...
とても便利な立地にあることが分かります。
![picture](../materials/06/figure_1.png)
...
![picture](../materials/06/figure_2.png)
...
![picture](../materials/06/figure_3.png)

まずは、バッファツールを起動します
メニューから [ベクタ] → [空間演算ツール] → [バッファ(buffer)] を選択。
![picture](../materials/06/figure_4.png)
...
事例を見てみましょう。
![picture](../materials/06/figure_7.png)
...
![picture](../materials/06/figure_8.png)
...
![picture](../materials/06/figure_10.png)
